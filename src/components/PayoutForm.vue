        ...
        <v-window v-model="tab">
          <v-window-item value="mobile_money">
            <v-select
              ...
              placeholder="Select Mobile money services provider"
              :items="bankList"
            />
              ...
              <v-card v-if="!user?.paystackRecipientCode">
                ...
                <v-card-actions>
                  ...
                  <paystack-checkout
                    ...
                    buttonText="Accept and Withdraw"
                    ...
                    :embed="false"
                  />
                  <v-btn v-else variant="outlined" disabled density="default" size="default" text="primary" theme="light">Accept and Widthdraw</v-btn>
                </v-card-actions>
              </v-card>
          </v-window-item>
        </v-window>
